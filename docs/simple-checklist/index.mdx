...
export const Flex = props => {
  return <div style={{ dispaly: 'flex', flexDirection: 'row', justifyContent: 'space-between'}}>{props.children}</div>;
};
...
<Flex>
  <Image src="https://nizukshya.com/simple-checklist/app-checklist.jpg" alt="Checklist 1" caption="Screenshot 1" width="50%" />
  <Image src="https://nizukshya.com/simple-checklist/app-checklist-2.png" alt="Checklist 2" caption="Screenshot 2 " width="50%" />
</Flex>
